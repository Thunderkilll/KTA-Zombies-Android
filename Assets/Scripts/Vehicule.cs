...
public class Vehicule : MonoBehaviour {
	...
	public bool inVehicule,nearVehicule=false;
	...
	public GameObject wheel,rifleButton,gunButton,meleeButton,knifeButton,tankBulletButton;
